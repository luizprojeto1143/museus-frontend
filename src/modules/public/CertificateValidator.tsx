                        ...
                        {status === 'invalid' && (
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-red-300/60 text-sm">{t("public.certificatevalidator.oCdigoFornecidoNoFoiEncontradoOuFoiRevog", `O código fornecido não foi encontrado ou foi revogado.`)}</p>
                                </div>
                            </div>
                        )}
