        ...
        <div className="landing-page" style={{
            ...
            <nav style={{
                ...
                <div style={{ display: "flex", gap: "2rem", fontSize: "0.95rem" }} className="desktop-menu" role="menubar">
                    <button role="menuitem" onClick={() => scrollToSection("solucoes")} style={{ background: "none", border: "none", color: "inherit", cursor: "pointer", fontFamily: "var(--font-body)" }}>{t("public.landingpage.solues", "Soluções")}</button>
                    ...
                    <button role="menuitem" onClick={() => scrollToSection("casos")} style={{ background: "none", border: "none", color: "inherit", cursor: "pointer", fontFamily: "var(--font-body)" }}>{t("public.landingpage.benefcios", "Benefícios")}</button>
                </div>
            ...
            {mobileMenuOpen && (
                <div style={{
                    ...
                    <button role="menuitem" onClick={() => scrollToSection("solucoes")} style={{ background: "none", border: "none", color: "var(--accent-primary)", fontSize: "1.2rem", textAlign: "left" }}>{t("public.landingpage.solues", "Soluções")}</button>
                    ...
                    <button role="menuitem" onClick={() => scrollToSection("casos")} style={{ background: "none", border: "none", color: "var(--accent-primary)", fontSize: "1.2rem", textAlign: "left" }}>{t("public.landingpage.benefcios", "Benefícios")}</button>
            ...
            <header style={{
                ...
                }}>{t("public.landingpage.plataformaDeGestoCultural40", "PLATAFORMA DE GESTÃO CULTURAL 4.0")}</div>
                ...
                <p style={{ maxWidth: "700px", margin: "0 auto 3rem", fontSize: "1.2rem", opacity: 0.8, lineHeight: "1.6", fontFamily: "var(--font-body)" }}>{t("public.landingpage.aSoluoCompletaParaDigitalizarM", "A solução completa para digitalizar museus e cidades históricas.
                    Engaje visitantes com gamificação, cumpra a Lei Rouanet com excelência e tenha controle total do seu acervo.")}</p>
                ...
                <div style={{ display: "flex", gap: "1rem", flexDirection: "row", flexWrap: "wrap", justifyContent: "center" }}>
                    ...
                    >{t("public.landingpage.conhecerSolues", "Conhecer Soluções")}</button>
                </div>
            </header>
            ...
            <section id="solucoes" style={{ padding: "6rem 2rem", maxWidth: "1200px", margin: "0 auto" }} aria-labelledby="features-title">
                <div style={{ textAlign: "center", marginBottom: "4rem" }}>
                    ...
                    <p style={{ opacity: 0.7, fontFamily: "var(--font-body)" }}>{t("public.landingpage.tudoOQueVocPrecisaParaModerniz", "Tudo o que você precisa para modernizar sua instituição.")}</p>
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "2rem" }}>
                    <div className="feature-card" style={{ padding: "2.5rem", background: "var(--bg-surface)", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-subtle)" }}>
                        ...
                        <p style={{ opacity: 0.7, fontFamily: "var(--font-body)", lineHeight: "1.6" }}>{t("public.landingpage.sistemaDeXpConquistasENveisQue", "Sistema de XP, conquistas e níveis que transforma a visitação em uma jornada engajadora.
                            Aumente a retenção e o interesse do público jovem com desafios interativos.")}</p>
                    </div>
                    <div className="feature-card" style={{ padding: "2.5rem", background: "var(--bg-surface)", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-subtle)" }}>
                        ...
                        <p style={{ opacity: 0.7, fontFamily: "var(--font-body)", lineHeight: "1.6" }}>{t("public.landingpage.semNecessidadeDeDownloadNasLoj", "Sem necessidade de download nas lojas. Seus visitantes acessam instantaneamente o guia multimídia
                            através de QR Codes inteligentes espalhados pelo acervo.")}</p>
                    </div>
                    <div className="feature-card" style={{ padding: "2.5rem", background: "var(--bg-surface)", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-subtle)" }}>
                        ...
                        <p style={{ opacity: 0.7, fontFamily: "var(--font-body)", lineHeight: "1.6" }}>{t("public.landingpage.mapasInterativosRoteirosSugeri", "Mapas interativos, roteiros sugeridos por IA e integração com a economia local.
                            Conecte seu museu ao ecossistema da cidade.")}</p>
                    </div>
                </div>
            </section>
            ...
            <section id="acessibilidade" style={{ padding: "8rem 2rem", background: "var(--bg-elevated)", position: "relative", overflow: "hidden" }} aria-labelledby="a11y-title">
                ...
                <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "5rem", alignItems: "center", position: "relative" }}>
                    <div>
                        ...
                        <p style={{ fontSize: "1.1rem", opacity: 0.8, marginBottom: "2.5rem", lineHeight: "1.6", fontFamily: "var(--font-body)" }}>{t("public.landingpage.garantaAAprovaoDaSuaPrestaoDeC", "Garanta a aprovação da sua prestação de contas. Nossa plataforma já vem com a suíte técnica exigida, e oferecemos a produção de conteúdo como serviço.")}</p>
                        ...
                        <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                            ...
                            <li style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                                ...
                                <div>
                                    ...
                                    <span style={{ fontSize: "0.9rem", opacity: 0.6, fontFamily: "var(--font-body)" }}>{t("public.landingpage.narraoDescritivaParaDeficiente", "Narração descritiva para deficientes visuais")}</span>
                                </div>
                            </li>
                            <li style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                    ...
                    <div style={{
                        ...
                        <p style={{ marginBottom: "2rem", fontFamily: "var(--font-body)", opacity: 0.8 }}>{t("public.landingpage.nossaEquipeDeEspecialistasProd", "Nossa equipe de especialistas produz os vídeos de Libras e os áudios de descrição para o seu acervo.")}</p>
            ...
            <section id="contato" style={{ padding: "6rem 2rem", maxWidth: "800px", margin: "0 auto" }}>
                <div style={{ textAlign: "center", marginBottom: "3rem" }}>
                    ...
                    <p style={{ opacity: 0.7, fontFamily: "var(--font-body)" }}>{t("public.landingpage.tireSuasDvidasSobreALeiRouanet", "Tire suas dúvidas sobre a Lei Rouanet, Planos e Implementação.")}</p>
                </div>
                <ContactForm />
            </section>
            ...
            <section style={{ padding: "8rem 2rem", textAlign: "center", background: "linear-gradient(to top, var(--bg-surface), var(--bg-page))" }}>
                ...
                <p style={{ maxWidth: "600px", margin: "0 auto 3rem", opacity: 0.7, fontSize: "1.2rem", fontFamily: "var(--font-body)" }}>{t("public.landingpage.junteseAosMuseusEProjetosCultu", "Junte-se aos museus e projetos culturais que já estão no futuro.
                    Crie seu espaço agora mesmo.")}</p>
                <button
