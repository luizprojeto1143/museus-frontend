        ...
        <div className="master-page-container">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    ...
                    <p className="opacity-70 mt-1">{t("master.plans.gerencieCamadasDeServioELimitesParaInsti", `Gerencie camadas de serviço e limites para instituições`)}</p>
                </div>
                <Button
                        ...
                        <div className="bg-blue-600/20 p-6 border-b border-white/5 relative">
                            ...
                            {plan.monthlyPrice !== undefined && (
                                <div className="text-2xl font-black mt-4 flex items-baseline gap-1">
                                    ...
                                    <span className="text-sm font-normal opacity-70">{t("master.plans.ms", `/mês`)}</span>
                                </div>
                            )}
                        </div>
