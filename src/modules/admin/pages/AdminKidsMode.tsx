            ...
            <div className="grid grid-cols-2 gap-6">
                <div className="card">
                    ...
                    <div className="bg-black/30 rounded-xl p-4 space-y-2">
                        ...
                        <p style={{ color: "#94a3b8", fontSize: "0.75rem" }}>{t("admin.kidsmode.estaPinturaLeoSobreTelaDatadaDoPerodoBar", `Esta pintura à óleo sobre tela, datada do período barroco brasileiro, apresenta características chiaroscuro típicas da escola...`)}</p>
                ...
                <div className="card" style={{ border: "1px solid rgba(34,197,94,0.2)" }}>
                    ...
                    <div className="bg-black/30 rounded-xl p-4 space-y-2" style={{ fontSize: '18px' }}>
                        ...
                        <p className="text-gray-300" style={{ fontSize: '0.9em', lineHeight: '1.8' }}>{t("admin.kidsmode.umaPinturaBemAntigaEBonitaOArtistaUsouTi", `Uma pintura bem antiga e bonita! O artista usou tintas especiais para fazer parecer que tem uma luz brilhando. Legal, né? ✨`)}</p>
