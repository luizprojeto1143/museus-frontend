        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <p className="text-zinc-400">{t("admin.notifications.envieMensagensEmTempoRealParaTodosOsUsur", `Envie mensagens em tempo real para todos os usuários do seu museu/instituição.`)}</p>
                </div>
                ...
                <div className="space-y-6">
                    <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-6">
                        ...
                        <ul className="text-amber-300 text-sm space-y-2 list-disc pl-4">
                            <li>{t("admin.notifications.sejaBreveEDiretoNotificaesCurtasTmMaiorT", `Seja breve e direto: notificações curtas têm maior taxa de clique.`)}</li>
                            <li>{t("admin.notifications.useEmojisParaChamarAAtenoMasSemExageros", `Use emojis para chamar a atenção, mas sem exageros.`)}</li>
                            <li>Sempre teste o envio em si mesmo antes de disparar para toda a base.</li>
                            <li>{t("admin.notifications.aMensagemSerEnviadaParaTodosOsDispositiv", `A mensagem será enviada para todos os dispositivos (Android, iOS e Web) registrados.`)}</li>
                        </ul>
                    </div>
