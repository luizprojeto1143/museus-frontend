        ...
        <div className="flex flex-col h-[calc(100vh-100px)] gap-4">
            ...
            <div className="flex justify-between items-center bg-surface-dark p-4 rounded-xl border border-white/10">
                <div>
                    ...
                    <p className="text-zinc-500 text-sm">{t("admin.mapeditor.selecioneUmaObraNaListaECliqueNoMapaPara", `
            ...
            <div className="flex flex-1 gap-4 overflow-hidden">
                ...
                <div className="flex-1 bg-black/20 rounded-xl overflow-hidden border border-white/10 relative">
                    ...
                    {/* Instruction Overlay */}
                    {!selectedWorkId && (
                        <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-black/80 backdrop-blur-md text-white px-4 py-2 rounded-full text-sm border border-white/10 z-[1000] pointer-events-none">{t("admin.mapeditor.selecioneUmaObraNaListaLateralParaComear", `
