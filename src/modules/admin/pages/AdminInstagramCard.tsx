    ...
    return (
        <div style={{ display: "grid", gap: "2rem" }}>
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div style={{ display: "grid", gap: "1rem" }}>
                    <div className="card" style={{ display: "grid", gap: "1rem" }}>
                        ...
                        <div>
                            ...
                            <textarea value={customText} onChange={e => setCustomText(e.target.value)} rows={3} placeholder="Deixe em branco para usar a descrição da obra" className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm outline-none resize-none focus:border-amber-500" />
                        </div>
                ...
                {/* Preview */}
                <div className="card">
                    <p className="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-3">Prévia 1080×1080</p>
