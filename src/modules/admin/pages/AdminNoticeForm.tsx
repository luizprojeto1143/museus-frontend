                    ...
                    >
                            ...
                            <div className="admin-section space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="md:col-span-1 form-group">
                                        <Input
                                            label={t("admin.notice.ttuloDoEdital", `Título do Edital *`)}
                                ...
                                <div className="form-group">
                                    <Textarea
                                        label={t("admin.notice.descrioObjetivoDoEdital", `Descrição / Objetivo do Edital *`)}
                                        rows={4}
                                        value={formData.description}
                                        onChange={e => setFormData({ ...formData, description: e.target.value })}
                                        placeholder={t("admin.notice.breveApresentaoDoEdital", `Breve apresentação do edital...`)}
                                        required
                                    />
                                </div>
                                ...
                                <div className="form-group">
                                    <Textarea
                                        label={t("admin.notice.objetivosEstratgicosParaAnliseIa", `Objetivos Estratégicos (Para Análise IA) *`)}
                                        rows={4}
                                        value={formData.objectives}
                                        onChange={e => setFormData({ ...formData, objectives: e.target.value })}
                                        placeholder={t("admin.notice.descrevaOQueEsteEditalBuscaFomentarSerUs", `Descreva o que este edital busca fomentar... (Será usado pela IA para avaliar mérito)`)}
                                        required
                                    />
                                </div>
                                ...
                                <div className="form-group">
                                    <Textarea
                                        label={t("admin.notice.requisitosTcnicosCritriosParaAnliseIa", `Requisitos Técnicos / Critérios (Para Análise IA) *`)}
                                        rows={4}
                                        value={formData.requirements}
                                        onChange={e => setFormData({ ...formData, requirements: e.target.value })}
                                        placeholder={t("admin.notice.listeOsCritriosDeEliminaoOuPontuaoSerUsa", `Liste os critérios de eliminação ou pontuação... (Será usado pela IA para checklist)`)}
                                        required
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="admin-section">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="form-group">
                                            <Input
                                                label={t("admin.notice.aberturaDasInscries", `Abertura das Inscrições *`)}
                                                type="date"
                                        ...
                                        <div className="form-group">
                                            <Input
                                                label={t("admin.notice.encerramentoDasInscries", `Encerramento das Inscrições *`)}
                                                type="date"
                                ...
                                <div className="admin-section">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="form-group">
                                            <Input
                                                label={t("admin.notice.divulgaoDosResultados", `Divulgação dos Resultados`)}
                                                type="date"
                                        ...
                                        <div className="form-group">
                                            <Input
                                                label={t("admin.notice.prazoFinalDeExecuo", `Prazo Final de Execução`)}
                                                type="date"
                        ...
                        {currentStep === 2 && (
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="admin-section">
                                        <h3 className="admin-section-title">{t("admin.notice.oramentoGeral", `Orçamento Geral`)}</h3>
                                        <div className="form-group">
                                            <Input
                                    ...
                                    <div className="admin-section">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="form-group">
                                                <Input
                                                    label={t("admin.notice.mnimoR", `Mínimo (R$)`)}
                                                    type="number"
                                                    step="0.01"
                                            ...
                                            <div className="form-group">
                                                <Input
                                                    label={t("admin.notice.mximoR", `Máximo (R$)`)}
                                                    type="number"
                                                    step="0.01"
                                ...
                                <div className="admin-section">
                                    ...
                                    <div className="flex flex-wrap gap-2 p-4 bg-zinc-950/30 rounded-lg min-h-[60px] border border-white/5">
                                        {formData.targetRegions.length === 0 && (
                                            <p className="text-zinc-500 italic text-sm">{t("admin.notice.nenhumaRegioRestritaAbrangnciaGlobal", `Nenhuma região restrita (Abrangência Global)`)}</p>
                                        )}
                        ...
                        {currentStep === 3 && (
                            <div className="space-y-6">
                                <div className="text-center p-8 bg-green-500/10 rounded-2xl border border-green-500/30">
                                    ...
                                    <h2 className="text-2xl font-bold text-white mb-2">{t("admin.notice.quaseL", `Quase lá!`)}</h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="admin-section space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex justify-between items-center py-2 border-b border-white/5">
                                                <span className="text-zinc-400">{t("admin.notice.ttulo", `Título:`)}</span>
                                                <span className="text-white font-medium">{formData.title}</span>
                                            </div>
                                            <div className="flex justify-between items-center py-2 border-b border-white/5">
                                                <span className="text-zinc-400">{t("admin.notice.oramento", `Orçamento:`)}</span>
                                                <span className="text-green-400 font-medium">
                                                    {formData.totalBudget ? `R$ ${Number(formData.totalBudget).toLocaleString()}` : 'N/A'}
                                                </span>
                                            </div>
                                            <div className="flex justify-between items-center py-2 border-b border-white/5">
                                                <span className="text-zinc-400">{t("admin.notice.inscries", `Inscrições:`)}</span>
                                    ...
                                    <div className="admin-section">
                                        <h3 className="admin-section-title mb-4">{t("admin.notice.configuraesFinais", `Configurações Finais`)}</h3>
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-xs text-zinc-400">{t("admin.notice.mostrarPontuaoFinalParaOPblico", `Mostrar pontuação final para o público`)}</div>
                                                </div>
                                            </div>
