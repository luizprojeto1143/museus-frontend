...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-12 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-7xl mx-auto">
      ...
      >
        {[
          { label: t("admin.dashboard.stats.visitors"), value: data.visitorsThisMonth, icon: Users, color: 'text-blue-400' },
          { label: t("admin.dashboard.stats.qrScans"), value: data.totalQRScans, icon: Ticket, color: 'text-purple-400' },
          { label: t("admin.dashboard.stats.xpDistributed"), value: data.totalXPDistributed, icon: Star, color: 'text-gold-400' },
          { label: t("admin.dashboard.stats.monthlyGrowth"), value: data.monthlyGrowth, icon: TrendingUp, color: 'text-green-400', unit: '%' },
        ].map((stat, i) => (
            ...
            >
              ...
              <div className="flex flex-col relative z-10">
                 ...
                 <div className="text-4xl font-black text-white tracking-tighter leading-none flex items-baseline">
                   {stat.unit === '%' && <span className="mr-1 opacity-50 text-2xl text-green-400">+</span>}
