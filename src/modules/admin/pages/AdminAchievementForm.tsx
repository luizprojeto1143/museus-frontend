              ...
              <div className="flex-col gap-6">
                <div className="admin-section">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Input
                      label={t("admin.achievement.cdigoNico", `Código Único`)}
                      value={form.code}
                  ...
                  <div className="p-4 bg-zinc-900/50 rounded-xl border border-white/5 flex flex-col gap-2">
                    <label className="flex items-center gap-3 cursor-pointer group">
                      ...
                      <input
                        ...
                        className="hidden"
                      />
                      <span className="font-medium text-zinc-200 group-hover:text-white transition-colors">{t("admin.achievement.desbloqueioAutomtico", `
                        Desbloqueio Automático
                      `)}</span>
                    </label>
                    <p className="text-xs text-zinc-500 ml-8">{t("admin.achievement.seMarcadoOSistemaAConcederAutomaticament", `
              ...
              <div className="flex-col gap-6">
                <div className="admin-grid-2">
                  <div className="admin-section">
                    ...
                    />
                    <p className="text-xs text-zinc-500 mt-2">{t("admin.achievement.xpConcedidoAoVisitanteQuandoAConquistaDe", `
              ...
              <div className="flex-col gap-6">
                ...
                <div className="admin-grid-2">
                  <div className="admin-section">
                    ...
                    <div className="summary-card">
                      <div className="summary-row">
                        <span className="summary-label">{t("admin.achievement.ttulo", `Título:`)}</span>
                        <span className="summary-value">{form.title}</span>
                      </div>
                      <div className="summary-row">
                        <span className="summary-label">{t("admin.achievement.cdigo", `Código:`)}</span>
                  ...
                  <div className="admin-section flex flex-col items-center justify-center text-center">
                    <h3 className="admin-section-title w-full">{t("admin.achievement.prvisualizao", `Pré-visualização`)}</h3>
