    ...
    return (
        <div>
            <div style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: '#64748b', fontSize: '0.85rem' }}>{t("admin.grouptickets.gerencieSolicitaesDeIngressosParaGruposE", `Gerencie solicitações de ingressos para grupos e escolas`)}</p>
            </div>
