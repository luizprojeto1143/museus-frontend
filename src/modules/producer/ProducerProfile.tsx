            ...
            <div className="bg-[#2c1e10] rounded-2xl p-8 border border-[#463420] shadow-lg shadow-black/20">
                <div className="flex items-center gap-4 mb-8 pb-6 border-b border-[#463420]">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[#B0A090]">{t("producer.producerprofile.informaesVisveisParaAdministradoresEEmSe", `Informações visíveis para administradores e em seus projetos`)}</p>
                    </div>
                </div>
