    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh]">
                ...
                <p className="text-zinc-500">Carregando classificação...</p>
            </div>
        );
    }
    ...
    if (!results) {
        return (
            <div className="max-w-4xl mx-auto py-20 text-center">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">Classificação Indisponível</h2>
                <p className="text-zinc-500 mb-8">Os resultados oficiais ainda não foram publicados para este edital.</p>
