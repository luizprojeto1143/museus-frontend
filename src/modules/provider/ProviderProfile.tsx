        ...
        <div className="max-w-4xl mx-auto space-y-8 pb-20">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-[#b794f4] mt-1">Gerencie como os produtores visualizam seus serviços.</p>
                </div>
                <Button
                    onClick={handleSave}
                    disabled={saving}
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-[#1a0f2c] p-6 rounded-3xl border border-[#3b2164] space-y-4">
                        ...
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-[#b794f4]">Avaliação Média</span>
                            <span className="text-white font-bold">4.9 / 5.0</span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-[#b794f4]">Projetos Concluídos</span>
                ...
                <div className="md:col-span-2 space-y-6">
                    <section className="bg-black/20 p-8 rounded-3xl border border-[#3b2164] space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-[#b794f4] uppercase tracking-widest ml-1">E-mail para Orçamentos</label>
                                <Input
                                    value={profile.email}
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-[#b794f4] uppercase tracking-widest ml-1">Descrição / Bio</label>
                            <Textarea
                        ...
                        <div className="space-y-4">
                            <label className="text-xs font-bold text-[#b794f4] uppercase tracking-widest ml-1">Serviços Oferecidos</label>
