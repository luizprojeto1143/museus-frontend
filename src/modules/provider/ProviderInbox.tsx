            ...
            <div className={`flex-1 flex flex-col bg-[#0f0a1a]/50 ${!selectedId ? 'hidden md:flex' : 'flex'}`}>
                {activeConversation ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-[#b794f4]/20 p-10 text-center">
                        ...
                        <p className="max-w-xs text-sm">{t("provider.providerinbox.selecioneUmaConversaAoLadoParaResponderA", `Selecione uma conversa ao lado para responder aos produtores e negociar seus serviços.`)}</p>
                    </div>
                )}
            </div>
        </div>
