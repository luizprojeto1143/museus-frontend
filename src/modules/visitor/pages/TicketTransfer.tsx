    ...
    if (success) {
        return (
            <div style={{ padding: '2rem', textAlign: 'center', maxWidth: '500px', margin: '0 auto' }}>
                ...
                <h1 style={{ fontSize: '1.5rem', fontWeight: 900, color: 'white', marginBottom: '0.5rem' }}>Transferência Concluída!</h1>
                ...
                <div style={{ marginTop: '1.5rem', background: 'rgba(30,32,38,0.9)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '1rem', padding: '1.5rem' }}>
                    <p style={{ color: '#aaa', fontSize: '0.8rem' }}>Novo código do ingresso:</p>
    ...
    return (
        <div style={{ padding: '1.5rem', maxWidth: '500px', margin: '0 auto' }}>
            ...
            <div style={{ background: 'rgba(30,32,38,0.9)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '1.25rem', padding: '1.5rem', display: 'grid', gap: '1rem' }}>
                <div>
                    <label style={{ display: 'block', color: '#aaa', fontSize: '0.8rem', fontWeight: 700, marginBottom: '0.5rem' }}>Código da Inscrição</label>
                    <input value={form.registrationId} onChange={e => setForm({ ...form, registrationId: e.target.value })} placeholder="Cole o ID da inscrição" style={{ width: '100%', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '0.75rem', padding: '0.75rem 1rem', color: 'white', fontSize: '0.9rem', outline: 'none' }} />
                </div>
                <div>
                    <label style={{ display: 'block', color: '#aaa', fontSize: '0.8rem', fontWeight: 700, marginBottom: '0.5rem' }}>Nome do Destinatário</label>
                ...
                <div>
                    <label style={{ display: 'block', color: '#aaa', fontSize: '0.8rem', fontWeight: 700, marginBottom: '0.5rem' }}>Email do Destinatário</label>
