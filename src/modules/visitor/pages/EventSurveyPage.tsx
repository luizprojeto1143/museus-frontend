        ...
        return (
            <div className="min-h-screen bg-[#0a0a0c] flex items-center justify-center p-4">
                <div className="text-center">
                    ...
                    <p className="text-slate-500 italic">{t("visitor.eventsurveypage.esteEventoNoPossuiUmaPesquisaAtivaNoMome", `Este evento não possui uma pesquisa ativa no momento.`)}</p>
                </div>
            </div>
        );
    }
                    ...
                    <form onSubmit={handleSubmit} className="p-10 space-y-10">
                        {!currentUser && (
                            <div className="bg-blue-500/10 p-6 rounded-2xl border border-blue-500/20 mb-8 space-y-4">
                                ...
                                />
                                <p className="text-xs text-blue-400 font-medium">{t("visitor.eventsurveypage.paraValidarSuaParticipaoInformeSeuEmail", `Para validar sua participação, informe seu e-mail.`)}</p>
                            </div>
                        )}
