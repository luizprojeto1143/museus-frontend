    ...
    return (
        <div style={{ display: "grid", gap: "2rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                    <h1 className="section-title" style={{ margin: 0 }}>{t("admin.tceexport.exportaoTcemg", `Exporta��o TCE-MG`)}</h1>
            ...
            <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] shadow-[var(--shadow-surface)] rounded-[var(--radius-lg)] p-6 transition-colors" style={{ overflow: "hidden", padding: 0 }}>
                <div className="px-6 py-4 border-b border-white/5 flex items-center gap-2">
                    ...
                    <h2 className="card-title" style={{ margin: 0 }}>Pr�via do Relat�rio � {year} Q{quarter}</h2>
                </div>
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-white/5">
                        {[
                            ...
                            { label: 'Avalia��es Recebidas', value: stats?.totalReviews || '0' },
