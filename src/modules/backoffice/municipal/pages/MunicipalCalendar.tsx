    ...
    return (
        <div style={{ display: "grid", gap: "2rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                    <h1 className="section-title" style={{ margin: 0 }}>{t("admin.municipalcalendar.calendrioCultural", `Calend�rio Cultural`)}</h1>
                    <p style={{ color: "#64748b", fontSize: "0.85rem", marginTop: "0.25rem" }}>{t("admin.municipalcalendar.visoUnificadaDaProgramaoMunicipal", `Vis�o unificada da programa��o municipal`)}</p>
                </div>
            ...
            <div className="card-grid">
                <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] shadow-[var(--shadow-surface)] rounded-[var(--radius-lg)] p-6 mb-4">
                    ...
                    <p className="stat-label">{t("admin.municipalcalendar.eventosNoMs", `Eventos no M�s`)}</p>
                </div>
                <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] shadow-[var(--shadow-surface)] rounded-[var(--radius-lg)] p-6 mb-4">
            ...
            {grouped.size === 0 ? (
                <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] shadow-[var(--shadow-surface)] rounded-[var(--radius-lg)] p-6 transition-colors" style={{ textAlign: "center", padding: "4rem 2rem", border: "2px dashed rgba(212,175,55,0.15)" }}>
                    ...
                    <p style={{ color: "#64748b" }}>{t("admin.municipalcalendar.nenhumEventoNesteMs", `Nenhum evento neste m�s`)}</p>
                </div>
            ) : (
