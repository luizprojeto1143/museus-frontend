        ...
        <div style={{ display: "grid", gap: "2rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                    ...
                    <p style={{ color: "#64748b", fontSize: "0.85rem", marginTop: "0.25rem" }}>{t("admin.conservation.manutenoRestauroEmprstimosDeObras", `Manutenção, restauro, empréstimos de obras`)}</p>
                </div>
            ...
            {showForm && (
                <div className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] shadow-[var(--shadow-surface)] rounded-[var(--radius-lg)] p-6 transition-colors" style={{ display: "grid", gap: "1rem" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                        ...
                        <div>
                            <label style={{ display: "block", color: "var(--accent-primary)", fontSize: "0.7rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "0.4rem" }}>Tipo</label>
                        ...
                        <div>
                            <label style={{ display: "block", color: "var(--accent-primary)", fontSize: "0.7rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "0.4rem" }}>{t("admin.conservation.condio", `Condição`)}</label>
                            ...
                            <div key={r.id} className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] shadow-[var(--shadow-surface)] rounded-[var(--radius-lg)] p-6 transition-colors" style={{ padding: "1.25rem", display: "flex", alignItems: "center", gap: "1rem" }}>
                                ...
                                {r.nextScheduled && (
                                    <div style={{ flexShrink: 0, textAlign: "right" }}>
                                        ...
                                        <p style={{ color: "var(--accent-primary)", fontSize: "0.75rem", fontWeight: 700 }}>{new Date(r.nextScheduled).toLocaleDateString("pt-BR")}</p>
                                    </div>
                                )}
                            </div>
                        );
            ...
            {tab === 'loans' && (
                <div style={{ display: "grid", gap: "0.75rem" }}>
                    {loans.length === 0 ? (
                        ...
                        return (
                            <div key={l.id} className="bg-[var(--bg-surface)] border border-[var(--border-subtle)] shadow-[var(--shadow-surface)] rounded-[var(--radius-lg)] p-6 transition-colors" style={{ padding: "1.25rem", borderColor: isOverdue ? 'border-red-500/30' : 'border-white/5' }}>
