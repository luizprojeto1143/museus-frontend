        ...
        {sent ? (
          <div style={{ textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "1.5rem", fontWeight: "bold", marginBottom: "1rem" }}>
              {t("auth.forgotpassword.sentTitle", "E-mail enviado!")}
            </h2>
            <p style={{ opacity: 0.7, marginBottom: "2rem", lineHeight: "1.6" }}>
              {t("auth.forgotpassword.sentDesc", "Se houver uma conta associada a {{email}}, você receberá as instruções de recuperação em instantes.", { email })}
            </p>
          ...
          <>
            <div style={{ marginBottom: "2rem" }}>
              <Link to="/login" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", color: "var(--fg-muted)", textDecoration: "none", fontSize: "0.9rem", marginBottom: "1.5rem" }}>
                <ArrowLeft size={16} /> {t("auth.forgotpassword.backToLogin", "Voltar ao login")}
              </Link>
              <h1 style={{ fontSize: "1.75rem", fontWeight: "bold", marginBottom: "0.5rem" }}>
                {t("auth.forgotpassword.title", "Esqueceu a senha?")}
              </h1>
              <p style={{ opacity: 0.7 }}>
                {t("auth.forgotpassword.subtitle", "Digite seu e-mail para receber as instruções de redefinição.")}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: "1.5rem" }}>
                <label style={{ display: "block", marginBottom: "0.5rem", fontSize: "0.9rem", color: "#ccc" }}>
                  {t("auth.forgotpassword.labelEmail", "E-mail")}
                </label>
              ...
              >
                {loading ? t("auth.forgotpassword.sending", "Enviando...") : t("auth.forgotpassword.submit", "Enviar Instruções")}
              </button>
            </form>
          </>
        )}
